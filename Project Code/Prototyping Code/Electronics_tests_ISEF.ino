...
// this will just run the BM motor on full and readout the limit switch and force sensor values. This helps with troubleshooting electronics issues with the sensors. 
void loop() {
  analogWrite(motorSIG,255);
  Serial.print("Limit switch: ");
  Serial.print(digitalRead(BM_limitswitch));
  Serial.print(",   Force Sensor: ");
  Serial.println(analogRead(force_OUT));
}
